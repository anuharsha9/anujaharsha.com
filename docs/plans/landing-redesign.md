# Landing Redesign — Implementation Plans

> Implementation plans for the landing-page redesign (from the .gemini and .agents working dirs).
...
<!-- merged from: .gemini/implementation-plan-landing-redesign.md -->
## ── source: `implementation-plan-landing-redesign.md` ──
...
<!-- merged from: .agents/implementation-plan.md -->
