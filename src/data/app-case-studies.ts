...
export const APP_CASE_STUDIES: Record<AppCaseStudyId, AppCaseStudy> = {
    ...
    'wealth-engine': {
        ...
        walkthrough: [
            ...
            { id: 'feature-a', image: '/images/walkthroughs/wealthengine-feature-a.jpg', label: 'Three life paths, ranked', caption: 'It ranks three life paths by savings power, runway, and goal-fit — and back-solves the annual savings each one actually needs. There\'s a dual-runway gauge too: your runway today versus an all-income-lost stress test. Decisions, not dashboards.' },
    ...
    'inkwell': {
        ...
        walkthrough: [
            ...
            { id: 'feature-a', image: '/images/walkthroughs/inkwell-feature-a.jpg', label: 'Decoupled write / publish', caption: 'It splits writing from publishing completely. You draft into a local archive during a burst, and every piece moves through idea, drafting, ready, published. So the dashboard answers the only question that matters in the moment — what can I actually ship right now?' },
