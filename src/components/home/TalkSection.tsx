    ...
    >
      <div className={`relative z-10 ${spacing.container} max-w-4xl mx-auto`}>
        ...
        >
          ...
          {/* Link Buttons — every one uses the canonical Button primitive.
              Same shape, same hover, same press. Resume gets accent-amber
              (the one semantic non-teal: "this is the hire-me CTA"); the
              rest are secondary glass. No more bespoke pills. */}
