    ...
    >
      ...
      <div className={`relative z-10 ${spacing.container}`}>
        ...
        >
          ...
          <div>
            <h2
              className="font-sans font-extrabold text-2xl md:text-4xl lg:text-5xl leading-relaxed tracking-wide"
            >
              <span className="bg-[linear-gradient(118deg,#ffffff_0%,#eafcff_28%,#9ceaf2_56%,#2fc6d5_80%,var(--accent-teal)_100%)] bg-clip-text text-transparent drop-shadow-[0_0_20px_var(--overlay-cyan-light-22)]">
                I design so I can be part of making<br />people&apos;s lives a little easier every day.
              </span>
            </h2>
          </div>
