                ...
                >
                    ...
                    >
                        <div className="flex flex-col items-center text-center max-w-4xl">
                            ...
                            >
                                I make the most powerful tool in the building — the one nobody likes to use — obvious. 13 years of product design in enterprise systems, most recently leading the UX modernization of a 50-year-old BI platform, where the team&apos;s work helped renew a multi-year, multi-million-dollar contract.
                            </motion.p>
                        </div>
