...
const EXPERIENCE: Role[] = [
    {
        ...
        bullets: [
            { lead: 'High-Stakes Legacy Modernization:', rest: 'Owned the UX for WebFOCUS releases 9.2 through 9.3.7 — including the modernization of an undocumented, 50-year-old scheduling engine (ReportCaster), the unified DSML Hub (IQ Plugin), and the AI surfaces (NLQ, Insights, ML) that shipped across the platform. Re-architected workflows processing 20M+ weekly jobs across a platform powering 17M+ concurrent users and 1M+ requests daily; the platform was named Best in Class in Dresner Advisory Services\' 2025 Industry Excellence Awards.' },
