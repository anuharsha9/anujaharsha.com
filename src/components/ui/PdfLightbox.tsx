...
export default function PdfLightbox({
    ...
    const downloadButton = (
        <a
            href={pdfUrl}
            download
            className="flex items-center gap-3 px-5 py-2.5 bg-slate-800 hover:bg-[var(--accent-teal)] text-zinc-200 hover:text-white rounded-lg text-sm font-medium transition-colors duration-200 group border border-slate-700 hover:border-[var(--accent-teal)]"
        >
