...
export default function WordUGameCard({ work, onPlay }: WordUGameCardProps) {
    return (
        <a
            ...
            className="group/game relative block aspect-[4/3] cursor-pointer overflow-hidden rounded-2xl border border-white/[0.08] bg-white/[0.02] backdrop-blur-sm transition-all duration-500 hover:border-[var(--accent-teal)]/50 hover:bg-white/[0.04] hover:shadow-[0_0_40px_-10px_var(--overlay-accent-30)] active:scale-[0.98]"
        >
            ...
            <div className="absolute inset-0 flex flex-col items-center justify-center p-8 text-center z-10">
                <div className="w-16 h-16 rounded-full bg-white/10 backdrop-blur-md border border-white/20 flex items-center justify-center group-hover/game:scale-125 group-hover/game:bg-[var(--accent-teal)] group-hover/game:border-[var(--accent-teal)] transition-all duration-300 ease-spring shadow-2xl mb-6">
                ...
                <div className="relative pointer-events-none transform transition-all duration-500">
                    ...
                    <div className="overflow-hidden h-0 group-hover/game:h-auto transition-all duration-500">
                        ...
                        <div className="mt-4 flex items-center justify-center opacity-0 group-hover/game:opacity-100 transition-opacity duration-500 delay-200">
                            <span className="px-4 py-1.5 rounded-full bg-[var(--accent-teal)]/20 border border-[var(--accent-teal)]/40 text-[var(--accent-teal)] text-xs font-mono font-bold uppercase tracking-widest shadow-[0_0_15px_var(--overlay-accent-20)]">
                                Click to Play
                            </span>
                        </div>
                    </div>
