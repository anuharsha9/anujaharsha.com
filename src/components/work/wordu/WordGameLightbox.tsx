...
export default function WordGameLightbox({ isOpen, onClose }: WordGameLightboxProps) {
    ...
    return (
        ...
        >
            ...
            <div className="relative w-[340px] md:w-[400px] aspect-[9/19.5] bg-black rounded-[55px] border-[8px] border-[#1a1a1a] shadow-2xl overflow-hidden ring-1 ring-white/10">
                ...
                <div className="absolute top-[100px] -left-[10px] w-[3px] h-[26px] bg-[#2a2a2a] rounded-l-md" /> {/* Mute */}
                <div className="absolute top-[140px] -left-[10px] w-[3px] h-[50px] bg-[#2a2a2a] rounded-l-md" /> {/* Vol Up */}
                <div className="absolute top-[200px] -left-[10px] w-[3px] h-[50px] bg-[#2a2a2a] rounded-l-md" /> {/* Vol Down */}
                <div className="absolute top-[180px] -right-[10px] w-[3px] h-[80px] bg-[#2a2a2a] rounded-r-md" /> {/* Power */}
            </div>
        </SystemLightbox>
    )
}
