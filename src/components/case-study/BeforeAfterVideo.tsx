...
export default function BeforeAfterVideo({ before, after, isLightBackground = true, comparisonNotes, password = 'anu-access', caseStudySlug = 'default' }: BeforeAfterVideoProps) {
                ...
                {!isBeforeVideoPublic && !isUnlocked ? (
                  <div className="absolute inset-0 bg-slate-50 flex items-center justify-center">
                    <div className="text-center space-y-3">
                      <div className="w-14 h-14 mx-auto bg-slate-100 border border-slate-200 flex items-center justify-center group-hover:scale-110 transition-transform">
                        <svg aria-hidden="true" className="w-7 h-7 text-slate-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
