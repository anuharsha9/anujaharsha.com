...
export default function ReadingProgress() {
 ...
 style={{ 
 scaleX, 
 background: 'linear-gradient(90deg, transparent 0%, rgba(6,182,212,0.5) 40%, rgba(139,92,246,0.9) 80%, rgba(255,255,255,1) 100%)',
 boxShadow: '0 0 12px rgba(139,92,246,0.6), 0 0 4px rgba(255,255,255,0.8)' 
 }}
 >
