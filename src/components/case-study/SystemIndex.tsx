          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-5 md:gap-6 max-w-3xl mx-auto">
            ...
            >
              ...
              >
                ...
                <h3 className="text-lg md:text-xl font-semibold text-white mb-2">Extended Portfolio</h3>
                ...
                >
                  ...
                  <div className="relative h-44 md:h-52 overflow-hidden">
                    ...
                    <div className="absolute top-4 left-4">
                      <span
                        className="inline-flex items-center gap-1.5 px-2.5 py-1 rounded-full border text-[10px] font-mono tracking-wider backdrop-blur-sm"
                        style={{
