        ...
        <div className="relative flex w-full flex-col items-center justify-center py-8 text-center">
            ...
            <div className="flex flex-col md:flex-row items-center justify-center gap-4 w-full max-w-3xl px-4">
                {[
                    ...
                    <motion.div
                        key={card.title}
                        className="w-full md:w-52 rounded-xl border border-[color-mix(in_srgb,var(--cs-accent),transparent_75%)] bg-[color-mix(in_srgb,var(--cs-accent),transparent_95%)] px-5 py-4 text-center backdrop-blur-sm"
