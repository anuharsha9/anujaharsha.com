                                        ...
                                        <>
                                            ...
                                            >
                                                <motion.div
                                                    ...
                                                    animate={{ opacity: 1, y: 0 }}
                                                    transition={{ delay: 0.5 }}
                                                    className="px-6 py-3 rounded-xl bg-[color-mix(in_srgb,var(--cs-accent),transparent_90%)] border border-[color-mix(in_srgb,var(--cs-accent),transparent_75%)] backdrop-blur-sm"
                                                >
